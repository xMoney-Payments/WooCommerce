	...
	if ( isset( $_POST['xmoney_payments_general_action'] ) ) {
		...
		$allowed_fields = array(
			...
			'edit_general_configuration' => array(
				...
				'checkout_theme'             => 'text',
				'theme_colorPrimary'         => 'text',
				'theme_colorDanger'          => 'text',
				'theme_colorBackground'      => 'text',
				'theme_colorText'            => 'text',
				'theme_colorTextSecondary'   => 'text',
				'theme_colorBorder'          => 'text',
				'theme_colorBorderFocus'     => 'text',
				'theme_colorTextPlaceholder' => 'text',
				'theme_colorBackgroundFocus' => 'text',
				'theme_borderRadius'         => 'text',
			),
