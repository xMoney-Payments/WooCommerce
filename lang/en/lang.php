...
$tw_lang['no_woocommerce_f'] = 'xMoney Payments requires WooCommerce plugin to work normally. Please activate it or install it from';
...
$tw_lang['configuration_subtitle'] = 'xMoney Payments general settings.';
...
$tw_lang['s_t_s_notification_desc'] = 'Put this URL in your xMoney Payments account.';
...
$tw_lang['suppress_email_desc'] = 'Option to suppress the communication sent by the ecommerce system, in order to configure it from xMoney Payments’s Merchant interface.';
...
$tw_lang['menu_main_title'] = 'xMoney Payments';
...
$tw_lang['ws_title'] = 'xMoney Payments';
$tw_lang['ws_description'] = 'Have your customers pay with xMoney Payments payment gateway.';
$tw_lang['ws_enable_disable_title'] = 'Enable/Disable';
$tw_lang['ws_enable_disable_label'] = 'Enable  xMoney Payments  Payments';
...
$tw_lang['ws_description_default'] = 'One integration, multiple payment methods.  xMoney Payments  enables you to accept payments from virtually anywhere in the world through a myriad of payment methods.';
$tw_lang['ws_enable_methods_title'] = 'Enable for shipping methods';
$tw_lang['ws_enable_methods_desc'] = 'If  xMoney Payments  is only available for certain shipping methods, set it up here. Leave blank to enable for all methods.';
$tw_lang['ws_enable_methods_placeholder'] = 'Select shipping methods';
$tw_lang['ws_vorder_title'] = 'Accept for virtual orders';
$tw_lang['ws_vorder_desc'] = 'Accept  xMoney Payments if the order is virtual';
...
/* Twispay Processor( Redirect page to xMoney Payments ) */
...
$tw_lang['wa_order_status_notice'] = ' xMoney Payments  payment finalised successfully';
...
$tw_lang['wa_order_failed_notice'] = 'xMoney Payments payment failed';
$tw_lang['wa_order_hold_notice'] = ' payment is on hold';
...
$tw_lang['default_description'] = 'Pay with xMoney Payments';