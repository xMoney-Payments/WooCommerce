...
$tw_lang['configuration_subtitle'] = 'Setări generale xMoney Payments.';
...
$tw_lang['s_t_s_notification_desc'] = 'Introdu această adresă URL în contul tău xMoney Payments.';
...
$tw_lang['suppress_email_desc'] = 'Opțiunea de a dezactiva comunicarea trimisă de sistemul de e-commerce, pentru a o configura din interfața de comerciant xMoney Payments.';
...
$tw_lang['ws_description'] = 'Invită-ți clienții să folosească gateway-ul de plată xMoney Payments.';
$tw_lang['ws_enable_disable_title'] = 'Activează/Dezactivează';
$tw_lang['ws_enable_disable_label'] = 'Activează plățile xMoney Payments';
...
$tw_lang['ws_description_default'] = 'O integrare, mai multe metode de plată. xMoney Payments vă permite să acceptați plăți practic de oriunde în lume, printr-o multitudine de metode de plată.';
$tw_lang['ws_enable_methods_title'] = 'Activează căile de expediere';
$tw_lang['ws_enable_methods_desc'] = 'Dacă xMoney Payments este disponibil numai pentru anumite căi de expediere, configurează-le de aici. Lasă necompletat pentru a activa toate căile.';
$tw_lang['ws_enable_methods_placeholder'] = 'Selectează căile de expediere';
$tw_lang['ws_vorder_title'] = 'Acceptă comenzile virtuale';
$tw_lang['ws_vorder_desc'] = 'Acceptă xMoney Payments în cazul comenzilor virtuale';
...
$tw_lang['wa_order_status_notice'] = 'Plata xMoney Payments a fost finalizată cu succes';
...
$tw_lang['wa_order_failed_notice'] = 'Plata xMoney Payments a fost finalizată cu eroare';
$tw_lang['wa_order_hold_notice'] = 'Plata xMoney Payments este in asteptare';
...
$tw_lang['default_description'] = 'Plateste cu xMoney Payments';
